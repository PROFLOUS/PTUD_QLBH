...
public class FrmCT_HoaDon extends javax.swing.JFrame {
    ...
    public void renderInfoHD(){
        ...
        lbDate.setText(changeDateToString(hd.getNgayLapHD()));
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCT_HoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCT_HoaDon().setVisible(true);
            }
        });
    }
